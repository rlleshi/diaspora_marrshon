...
export const scandals: Scandal[] = [
  ...
  },
  {
    ...
    confidence: `e lartë (i kryqëzuar me Balkan Insight, Albanian Daily News, Shqiptarja.com, Politiko.al, Pamfleti.net, BalkanWeb, Shekulli, Hashtag.al, CNA.al, Panorama.al, RTSH)`,
    sources: [
  ...
  },
  {
    ...
    claims: [
      ...
      {
        claim: `Klientët i detyrohen OSHEE-së 750 milionë euro në fatura të papaguara deri në 2023`,
        verdict: "confirmed",
        note: `Konfirmuar nga telegraf.al (maj 2024) dhe raporti final i KLSH (shkurt 2025): 750 milionë euro janë detyrime të klientëve (jo borxh i vetë OSHEE) deri në 2023, nga mbi 564,000 debitorë; kronologjia: 2013 ~9M euro, 2022 687M euro (gusht).`,
      },
      {
    ...
    statusBucket: "investigation",
    yearStart: 2013,
    teaser: `Faturat e papaguara ndaj energjetikës shtetërore u rritën nga 9 milionë në 750 milionë euro brenda një dekade.`,
    ...
    claims: [
      {
        ...
        verdict: "partial",
        note: `Vendimi origjinal ICSID (2019) ishte ~108-110 mln euro (kryegjë+kosto), rreth 60% e totalit; me interesa, shuma e bllokuar te Eurocontrol/Albcontrol arriti ~130-135 mln euro deri fund 2024. Shifra prej ~130 mln euro është pra afërsisht e saktë, por përfaqëson fazën e ekzekutimit/interesave, jo shumën origjinale të vendimit.`,
      },
      {
  ...
  },
  {
    ...
    confidence: `e lartë (pjesa Balluku/SPAK) / mesatare (detajet shtesë të Unazës dhe tunelit)`,
    sources: [
  ...
  },
  {
    ...
    verificationNotes: `citizens.al (4 korrik 2025) citon edhe pretendimet e vetë kompanisë (investime 4,5 miliardë dollarë, rentë minerare e paguar mbi 730 milionë dollarë) dhe shifrat historike të shtetit (shpenzime të dyshimta rreth 220 milionë dollarë, detyrime tatimore të papaguara rreth 75 milionë dollarë).`,
    confidence: `mesatare`,
    sources: [
  ...
  },
  {
    ...
    verificationNotes: `Një pretendim tjetër, i një lëvizjeje aktiviste, flet për "mbi 1 miliard euro" — por ai i referohet kostos historike totale të gjithë rrugës që nga ndërtimi fillestar 2006-2010, jo vlerës specifike të kontratës koncesionare 2016-2018, dhe nuk e kundërshton kështu shifrën 350 milionë euro.`,
    confidence: `mesatare`,
    sources: [
...
Një investigim i gjerë i BIRN-it ("The Albanian Files", korrik 2026) dokumenton një model të pretenduar miratimesh të parregullta, të lehtësuara politikisht, për zhvillime të larta e luksoze në Tiranë gjatë qeverisjes Rama — përfshirë kullën 44-katëshe "Sun Moon Star" (arkitekt Sam Chermayeff), e cila mori leje zhvillimi KKT saktësisht për 30.000 m² sipërfaqe që arkitekti thotë se iu premtua nga një zyrtar i AZHT-së tre muaj më parë; arkitektin austriak Chris Precht, i cili thotë se kryeministri Rama e kontaktoi drejtpërdrejt në Instagram, që më pas projektoi strukturën "Eden" të ndërtuar brenda oborrit të Kryeministrisë; dhe pretendimin e kritikut Fatos Lubonja se disa projekte, përfshirë një resort pesë-yjesh të lidhur me Jared Kushner, ishin planifikuar mbi tokë të mbrojtur përpara se ndryshimet ligjore që e mundësonin këtë të miratoheshin fare — çka ai e quan provë "kapjeje shtetërore" (state capture). Kjo forcon lidhjen e dokumentuar mes bumit të ndërtimit në Tiranë dhe përfitimeve të përqendruara politikisht; investigimi është kryqëzuar me versionin origjinal anglisht të Balkan Insight (9 korrik 2026) dhe versionin shqip të Reporter.al.`,
    ...
    claims: [
      {
        ...
        verdict: "partial",
        note: `Shuma konkrete e pezulluar/bllokuar nga Komisioni Evropian sipas OLAF dhe citizens.al është 112 milionë euro (financim IPARD III). 146 milionë euro duket të jetë vlera totale e planifikuar e programit IPARD III për Shqipërinë 2021-2027, jo shuma specifike e bllokuar - dy shifrat konfondohen shpesh.`,
      },
      {
  ...
  },
  {
    ...
    period: `2013–2026 (rrjeti i koncesioneve nis më 2005, nën qeveritë e mëparshme)`,
    narrative: [
    ...
    statusBucket: "no-process",
    yearStart: 2013,
    teaser: `Numri i hidrocentraleve private aktive u rrit nga 80 në 2013 në 238 në 2024; dhjetëra ndodhen brenda parqeve kombëtare të mbrojtura.`,
    redactedPhrase: `nga 80 në 2013 në 238 në 2024`,
  },
  {
  ...
  },
  {
    ...
    claims: [
      ...
      },
      {
        ...
        verdict: "partial",
        note: `Shifra përmendet në artikullin e Wikipedia-s shqip mbi skandalin, por s'u gjet burim i dytë i pavarur për të konfirmuar shifrën e saktë ose rezultatin final të padive — mbetet e mbështetur në një burim të vetëm.`,
      },
    ],
    confidence: `mesatare`,
    sources: [
  ...
  },
  {
    ...
    statusBucket: "no-process",
    yearStart: 2022,
    teaser: `Hakerat iranianë çaktivizuan shërbimet shtetërore online për disa ditë, me pasoja që vazhduan vite me radhë — Shqipëria preu marrëdhëniet me Iranin.`,
    redactedPhrase: `vite me radhë`,
  },
  {
    ...
    claims: [
      {
        ...
        verdict: "confirmed",
        note: `Konfirmuar nga Ministria e Brendshme dhe disa media (top-channel.tv, abcnews.al, balkanweb.com): sistemi u çaktivizua si masë paraprake në Rinas, Kakavijë, Kapshticë, portet e Durrësit e Vlorës natën e 9-10 shtatorit 2022. Burime fillestare kishin folur për ~3 ditë rikthim, por verifikimi i mëvonshëm (shqiptarja.com, BalkanInsight/BIRN) tregon rikthim të plotë brenda rreth 24 orësh.`,
      },
      {
  ...
  },
  {
    ...
    verificationNotes: `Shuma kumulative e financimit ndërkombëtar (detajuar në claims[]) e kalon qartë "qindra milionë euro". Karakteri i financimit (kredi/instrumente urgjente, jo grante të pastra) e bën të saktë përshkrimin si "borxh". Pretendimet shtesë të kontekstit — firma të lidhura me PS sipas KLSH/BIRN, çmime të fryra respiratorësh — mbeten të paverifikuara dhe nuk përfshihen në këtë konkluzion, i cili mbulon vetëm shifrën e financimit ndërkombëtar.`,
    confidence: `mesatare`,
    sources: [
  ...
  },
  {
    ...
    claims: [
      ...
      },
      {
        ...
        verdict: "contradicted",
        note: `Shifra 100 kg përsëritet gjerësisht në media, por si sasi totale e sekuestruar, jo si kokainë e pastër: Top-Channel.tv dhe standard.al e përshkruajnë shprehimisht si "kokainë e përzier". Një burim (balkanweb.com) e ndan në ~19,4 kg kokainë e pastër, ~77,7 kg lëndë e dyshuar dhe ~19,8 kg përzierës (total ~117 kg). Pretendimi që i gjithë sasia prej 100 kg të ishte kokainë e pastër nuk mbështetet nga burimet.`,
      },
      {
      ...
      {
        claim: `Lidhje e pretenduar mes Olsi Ramës (vëllai i Edi Ramës) dhe grupit të Xibrakës përmes një automjeti të përbashkët`,
        verdict: "partial",
