...
export const participation: ParticipationDay[] = [
  ...
  { day: 54, date: "2026-07-23", saturday: false, peak: 6.04, mean: 3.17, median: 3.11, source: yt("xxG6yJ8Z0JI"),
    note: { sq: "Ditë me dy aksione: në mëngjes protestuesit përballen me dhunë shtazarake nga policia te Kuvendi, me gaz lotsjellës e top uji dhe disa aktivistë të ndaluar për pak kohë; në mbrëmje marshimi del po aq i fortë sa i djeshmi, shenjë se dhuna e mëngjesit s'i largoi njerëzit nga shesh, dhe mbyllet pa asnjë incident të ri.", en: "A day with two actions: in the morning protesters face savage police violence outside Parliament, with tear gas, water cannon and several activists briefly detained; in the evening turnout holds as strong as the day before, a sign the morning's violence didn't keep people away, and the march closes without a repeat incident." },
  ...
  { day: 57, date: "2026-07-26", saturday: false, peak: 5.20, mean: 3.06, median: 3.04, source: yt("sYLsq3E6jP8"),
    note: { sq: "E diela sjell vazhdimësi të qetë pas së shtunës: nga Skënderbeu në Kryeministri jehojnë parullat “Ju erdhi fundi” dhe “Parlamenti i krimit”; marshimi nëpër qendër mbyllet pa asnjë incident dhe bëhet urë drejt aksionit të Kuvendit të nesërmen në mëngjes.", en: "Sunday brings a quiet continuation after Saturday: from Skanderbeg Square to the PM's office echo the chants “your time is up” and “parliament of crime”; the march through the center closes without incident and becomes the bridge to the next morning's Parliament action." } },
