...
export const participation: ParticipationDay[] = [
  ...
  { day: 21, date: "2026-06-20", saturday: true, peak: 100.0, mean: 19.43, median: 15.76, source: yt("LDYTp4i8PEY"),
    note: { sq: "Dita më e madhe: diaspora zbret, mbi 100 mijë në shesh sipas vlerësimit gjeometrik.", en: "The biggest day: the diaspora turns out, an estimated 100,000+ in the square by ground geometry." } },
